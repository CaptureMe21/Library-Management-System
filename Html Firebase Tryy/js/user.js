            ...
            function searchBooks() {
                ...
                onValue(userRef, (snapshot) => {
                    ...
                    snapshot.forEach((childSnapshot) => {
                        ...
                        if (userData.userId.toLowerCase().includes(searchTerm)) {
                            hasResults = true;
                            // Append a new row to the table for each matching user
                            tableBody.innerHTML += `
                                <tr>
                                    <td><a onclick="showPopup('${userId}'); return false;" href="#">${userData.namef} ${userData.namel}</a></td>
                                    <td>${userId}</td>
                                </tr>
                            `;
                        }
                    ...
                    if (!hasResults) {
                        tableBody.innerHTML = '<tr><td colspan="2">No matching user found.</td></tr>';
                    }
                });
            }
